...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [self.scrollView addSubview:self.s_View];
...
//    maskLayer.bounds = CGRectMake(0, 0, 0, CGRectGetHeight(self.bounds));
    maskLayer.bounds = CGRectMake(-self.bounds.size.width, 0, self.bounds.size.width, CGRectGetHeight(self.bounds));
...
- (UIScrollView *)scrollView {
    if (!_scrollView) {
        ...
        _scrollView.layer.borderColor = [UIColor systemBlueColor].CGColor;
